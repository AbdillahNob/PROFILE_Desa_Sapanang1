...
$query_persuratan = view("SELECT * FROM tb_surat_masuk");
...
$tampilkanData = view("SELECT * FROM tb_surat_masuk LIMIT $dataAwal,$dataPerhalaman");
                ...
                while ($row = mysqli_fetch_array($tampilkanData)) : ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="download_surat_masuk.php?id=<?= $row['id_surat_masuk'] ?>" class="btn normal bg-olive">Download</a>
                        <a href="edit_surat_masuk.php?id=<?= $row['id_surat_masuk'] ?>" class="btn normal bg-primary">Edit</a>
                        <a href="hapus_surat_masuk.php?id=<?= $row['id_surat_masuk'] ?>&no_file=8" onclick="return confirm('Yakin hapus ?')" class="btn normal bg-maroon">Hapus</a>
                      </td>
                    </tr>

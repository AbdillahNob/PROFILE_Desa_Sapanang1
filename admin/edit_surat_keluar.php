<?php 
    ...
    $id = $_GET['id'];
    $query_persuratan = view("SELECT * FROM tb_surat_keluar WHERE id_surat_keluar = $id");
            ...
            echo 
                "<script>
                    setTimeout(function () {
                      Swal.fire({
                          title: 'Berhasil',
                          text: 'Berhasil Edit Arsip Surat Keluar',
                          icon: 'success',
                          timer: '3200',
            ...
            echo 
                "<script>
                    setTimeout(function () {
                      Swal.fire({
                          title: 'INFO',
                          text: 'Tidak ada perubahan Arsip Surat Keluar',
                          icon: 'warning',
                          timer: '3200',
                          showConfirmButton: false
                      });
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Edit Surat Keluar Desa</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <form role="form" action="" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="id" value="<?= $row['id_surat_keluar'] ?>">                

 ...
 <footer class="site-footer">
     <div class="container">
        <div class="col-md-6 col-sm-6 col-xs-6">
            <small class="copyright"><i>by</i> . KKN-T UNDIPA <b><a href="https://id.wikipedia.org/wiki/Universitas_Dipa_Makassar">( Universitas Dipa Makassar ) </a></b> GEL-01</small>
            <small class="pull-left"><a href="https://id.wikipedia.org/wiki/Universitas_Dipa_Makassar"><img src="img/sapanang/undipa.png" width="15" height="50"></a></small>

        </div>
        <div class="social-icon pull-right">
            <a><i class="fa fa-phone"></i> <i>081355849885</i></a>
